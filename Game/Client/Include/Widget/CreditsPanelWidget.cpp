...
void CCreditsPanelWidget::Construct()
{
    ...
    context1->GetTransform()->SetRelativeScale(0.6f, 0.04f);
    context1->GetTransform()->SetRelativePos(0.02f, 0.1f);
    ...
    context2->GetTransform()->SetRelativeScale(0.25f, 0.04f);
    ...
    context3->GetTransform()->SetRelativeScale(0.5f, 0.04f);
    context3->GetTransform()->SetRelativePos(0.02f, 0.25f);
    ...
    context4->GetTransform()->SetRelativeScale(0.225f, 0.04f);
    ...
    context5->GetTransform()->SetRelativeScale(0.95f, 0.04f);
    context5->GetTransform()->SetRelativePos(0.02f, 0.4f);
    ...
    context6->GetTransform()->SetRelativeScale(0.95f, 0.04f);
